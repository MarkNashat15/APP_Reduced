 ...
 */
public class GLPreviewActivityFEV1 extends Activity implements Device.Delegate, FrameProcessor.Delegate, Device.StreamDelegate, Device.PowerUpdateDelegate {
    ...
    public void onFrameProcessed(final RenderedImage renderedImage) {
        ...
        if (startRecording && renderedImage.imageType() == RenderedImage.ImageType.ThermalRadiometricKelvinImage) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double screenHieght = Resources.getSystem().getDisplayMetrics().heightPixels;


        final TextView rect = ((TextView) findViewById(R.id.textView3));
        final int realWidth = (int) (0.3 * screenWidth);
        final int realHieght = (int) (0.1 * screenHieght);
        rect.setWidth(realWidth);
        rect.setHeight(realHieght);
    ...
    public void calculateBreathRate() {
        ...
        Intent intent = new Intent(GLPreviewActivityFEV1.this, resultsPreview.class);
